...
namespace BlackedinSite.Controllers
{
    public class ContatoController : Controller
    {
        ...
        public ContatoController(BancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ResultadoContato")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ResultadoContato")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
